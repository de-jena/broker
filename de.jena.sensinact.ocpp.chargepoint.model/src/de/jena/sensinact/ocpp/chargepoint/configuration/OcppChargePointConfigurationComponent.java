...
public class OcppChargePointConfigurationComponent {
	...
	/**
	 * Registers the OcppChargePointResourceFactoryImpl as a service.
	 *
	 * @generated
	 */
	private void registerResourceFactoryService(BundleContext ctx){
		OcppChargePointResourceFactoryImpl factory = new OcppChargePointResourceFactoryImpl();
		Hashtable<String, Object> properties = new Hashtable<String, Object>();
		properties.putAll(factory.getServiceProperties());
		String[] serviceClasses = new String[] {OcppChargePointResourceFactoryImpl.class.getName(), Factory.class.getName()};
