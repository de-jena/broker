 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.model.ttn.impl.ApplicationIdsImpl#getApplicationId <em>Application Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationIdsImpl extends MinimalEObjectImpl.Container implements ApplicationIds {
	...
	protected EClass eStaticClass() {
		return TTNPackage.eINSTANCE.getApplicationIds();
	}
	...
	public void setApplicationId(String newApplicationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TTNPackage.APPLICATION_IDS__APPLICATION_ID, oldApplicationId, applicationId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TTNPackage.APPLICATION_IDS__APPLICATION_ID:
