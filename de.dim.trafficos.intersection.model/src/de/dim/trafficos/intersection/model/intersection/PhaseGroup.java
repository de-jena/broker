 ...
 * </p>
 * <ul>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.PhaseGroup#getId <em>Id</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.PhaseGroup#getPenalty <em>Penalty</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.PhaseGroup#getPhase <em>Phase</em>}</li>
 * </ul>
 *
 * @see de.dim.trafficos.intersection.model.intersection.TOSIntersectionPackage#getPhaseGroup()
 * @model
 * @generated
 */
public interface PhaseGroup extends EObject {
	 ...
	 * @see #setId(String)
	 * @see de.dim.trafficos.intersection.model.intersection.TOSIntersectionPackage#getPhaseGroup_Id()
	 * @model required="true"
	 * @generated
	 */
	String getId();
	...
	/**
	 * Sets the value of the '{@link de.dim.trafficos.intersection.model.intersection.PhaseGroup#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPenalty(int)
	 * @see de.dim.trafficos.intersection.model.intersection.TOSIntersectionPackage#getPhaseGroup_Penalty()
	 * @model required="true"
	 * @generated
	 */
	int getPenalty();
	...
	/**
	 * Sets the value of the '{@link de.dim.trafficos.intersection.model.intersection.PhaseGroup#getPenalty <em>Penalty</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dim.trafficos.intersection.model.intersection.TOSIntersectionPackage#getPhaseGroup_Phase()
	 * @model required="true"
	 * @generated
	 */
