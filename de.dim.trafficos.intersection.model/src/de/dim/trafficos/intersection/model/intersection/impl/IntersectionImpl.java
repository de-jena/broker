 ...
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getPhaseGroup <em>Phase Group</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getTimeTable <em>Time Table</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getProgram <em>Program</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getState <em>State</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dim.trafficos.intersection.model.intersection.impl.IntersectionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
