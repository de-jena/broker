 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getGatewayIds <em>Gateway Ids</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getTime <em>Time</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getRssi <em>Rssi</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getChannelRssi <em>Channel Rssi</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getSnr <em>Snr</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getUplinkToken <em>Uplink Token</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getReceivedAt <em>Received At</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.RxMetadataImpl#getChannelIndex <em>Channel Index</em>}</li>
 * </ul>
 *
 * @generated
 */
