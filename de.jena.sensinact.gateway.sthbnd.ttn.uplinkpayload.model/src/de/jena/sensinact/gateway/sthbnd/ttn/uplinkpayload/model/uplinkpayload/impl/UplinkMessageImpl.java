 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getSessionKeyId <em>Session Key Id</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFPort <em>FPort</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFCnt <em>FCnt</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFrmPayload <em>Frm Payload</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getRxMetadata <em>Rx Metadata</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getSettings <em>Settings</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getGatewayChannelIndex <em>Gateway Channel Index</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getDeviceChannelIndex <em>Device Channel Index</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getDecodedPayload <em>Decoded Payload</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getNetworkIds <em>Network Ids</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getConsumedAirtime <em>Consumed Airtime</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getReceivedAt <em>Received At</em>}</li>
 *   <li>{@link de.jena.sensinact.gateway.sthbnd.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getVersionIds <em>Version Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
