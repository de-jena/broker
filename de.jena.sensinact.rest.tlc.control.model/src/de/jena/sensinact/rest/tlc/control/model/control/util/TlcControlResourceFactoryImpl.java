...
public class TlcControlResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_NAME, TlcControlPackage.eNAME);
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_FILE_EXT, "tlccontrol");
