...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.ApplicationIds;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.EndDeviceIdsImpl#getDeviceId <em>Device Id</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.EndDeviceIdsImpl#getApplicationIds <em>Application Ids</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.EndDeviceIdsImpl#getDevEui <em>Dev Eui</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.EndDeviceIdsImpl#getJoinEui <em>Join Eui</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.EndDeviceIdsImpl#getDevAddr <em>Dev Addr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndDeviceIdsImpl extends MinimalEObjectImpl.Container implements EndDeviceIds {
	...
	protected EClass eStaticClass() {
		return UplinkPayloadPackage.eINSTANCE.getEndDeviceIds();
	}
	...
	public void setDeviceId(String newDeviceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__DEVICE_ID, oldDeviceId, deviceId));
	}
	...
	public NotificationChain basicSetApplicationIds(ApplicationIds newApplicationIds, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS, oldApplicationIds, newApplicationIds);
	...
	public void setApplicationIds(ApplicationIds newApplicationIds) {
		if (newApplicationIds != applicationIds) {
			...
			if (applicationIds != null)
				msgs = ((InternalEObject)applicationIds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS, null, msgs);
			if (newApplicationIds != null)
				msgs = ((InternalEObject)newApplicationIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS, null, msgs);
			msgs = basicSetApplicationIds(newApplicationIds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS, newApplicationIds, newApplicationIds));
	}
	...
	public void setDevEui(String newDevEui) {
		...
		devEui = newDevEui;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__DEV_EUI, oldDevEui, devEui));
	}
	...
	public void setJoinEui(String newJoinEui) {
		...
		joinEui = newJoinEui;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__JOIN_EUI, oldJoinEui, joinEui));
	}
	...
	public void setDevAddr(String newDevAddr) {
		...
		devAddr = newDevAddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.END_DEVICE_IDS__DEV_ADDR, oldDevAddr, devAddr));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UplinkPayloadPackage.END_DEVICE_IDS__DEVICE_ID:
				return getDeviceId();
			case UplinkPayloadPackage.END_DEVICE_IDS__APPLICATION_IDS:
				return getApplicationIds();
			case UplinkPayloadPackage.END_DEVICE_IDS__DEV_EUI:
				return getDevEui();
			case UplinkPayloadPackage.END_DEVICE_IDS__JOIN_EUI:
				return getJoinEui();
			case UplinkPayloadPackage.END_DEVICE_IDS__DEV_ADDR:
				return getDevAddr();
		}
