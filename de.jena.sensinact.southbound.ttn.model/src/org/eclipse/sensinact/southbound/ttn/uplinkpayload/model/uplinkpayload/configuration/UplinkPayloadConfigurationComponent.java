/*
 */
package org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.configuration;
...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkPayloadPackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.UplinkPayloadFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.UplinkPayloadPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"" , "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload" })
