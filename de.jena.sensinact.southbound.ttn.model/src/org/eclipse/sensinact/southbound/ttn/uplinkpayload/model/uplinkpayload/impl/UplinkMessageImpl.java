...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.NetworkIds;
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.RxMetadata;
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.Settings;
...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.VersionIds;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getSessionKeyId <em>Session Key Id</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFPort <em>FPort</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFCnt <em>FCnt</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getFrmPayload <em>Frm Payload</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getRxMetadata <em>Rx Metadata</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getSettings <em>Settings</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getGatewayChannelIndex <em>Gateway Channel Index</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getDeviceChannelIndex <em>Device Channel Index</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getDecodedPayload <em>Decoded Payload</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getNetworkIds <em>Network Ids</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getConsumedAirtime <em>Consumed Airtime</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getReceivedAt <em>Received At</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.UplinkMessageImpl#getVersionIds <em>Version Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UplinkMessageImpl extends MinimalEObjectImpl.Container implements UplinkMessage {
	...
	protected EClass eStaticClass() {
		return UplinkPayloadPackage.eINSTANCE.getUplinkMessage();
	}
	...
	public void setSessionKeyId(String newSessionKeyId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__SESSION_KEY_ID, oldSessionKeyId, sessionKeyId));
	}
	...
	public void setFPort(int newFPort) {
		...
		fPort = newFPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__FPORT, oldFPort, fPort));
	}
	...
	public void setFCnt(int newFCnt) {
		...
		fCnt = newFCnt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__FCNT, oldFCnt, fCnt));
	}
	...
	public void setFrmPayload(String newFrmPayload) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__FRM_PAYLOAD, oldFrmPayload, frmPayload));
	}
	...
	public EList<RxMetadata> getRxMetadata() {
		if (rxMetadata == null) {
			rxMetadata = new EObjectContainmentEList<RxMetadata>(RxMetadata.class, this, UplinkPayloadPackage.UPLINK_MESSAGE__RX_METADATA);
		}
		return rxMetadata;
	}
	...
	public NotificationChain basicSetSettings(Settings newSettings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS, oldSettings, newSettings);
	...
	public void setSettings(Settings newSettings) {
		if (newSettings != settings) {
			...
			if (settings != null)
				msgs = ((InternalEObject)settings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS, null, msgs);
			if (newSettings != null)
				msgs = ((InternalEObject)newSettings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS, null, msgs);
			msgs = basicSetSettings(newSettings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS, newSettings, newSettings));
	}
	...
	public void setGatewayChannelIndex(int newGatewayChannelIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__GATEWAY_CHANNEL_INDEX, oldGatewayChannelIndex, gatewayChannelIndex));
	}
	...
	public void setDeviceChannelIndex(int newDeviceChannelIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__DEVICE_CHANNEL_INDEX, oldDeviceChannelIndex, deviceChannelIndex));
	}
	...
	public EMap<String, Object> getDecodedPayload() {
		if (decodedPayload == null) {
			decodedPayload = new EcoreEMap<String,Object>(UplinkPayloadPackage.eINSTANCE.getStringToObjectMap(), StringToObjectMapImpl.class, this, UplinkPayloadPackage.UPLINK_MESSAGE__DECODED_PAYLOAD);
		}
	...
	public NotificationChain basicSetNetworkIds(NetworkIds newNetworkIds, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__NETWORK_IDS, oldNetworkIds, newNetworkIds);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNetworkIds(NetworkIds newNetworkIds) {
		if (newNetworkIds != networkIds) {
			NotificationChain msgs = null;
			if (networkIds != null)
				msgs = ((InternalEObject)networkIds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__NETWORK_IDS, null, msgs);
			if (newNetworkIds != null)
				msgs = ((InternalEObject)newNetworkIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__NETWORK_IDS, null, msgs);
			msgs = basicSetNetworkIds(newNetworkIds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__NETWORK_IDS, newNetworkIds, newNetworkIds));
	}
	...
	public void setConsumedAirtime(String newConsumedAirtime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__CONSUMED_AIRTIME, oldConsumedAirtime, consumedAirtime));
	}
	...
	public void setReceivedAt(String newReceivedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__RECEIVED_AT, oldReceivedAt, receivedAt));
	}
	...
	public NotificationChain basicSetVersionIds(VersionIds newVersionIds, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__VERSION_IDS, oldVersionIds, newVersionIds);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersionIds(VersionIds newVersionIds) {
		if (newVersionIds != versionIds) {
			NotificationChain msgs = null;
			if (versionIds != null)
				msgs = ((InternalEObject)versionIds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__VERSION_IDS, null, msgs);
			if (newVersionIds != null)
				msgs = ((InternalEObject)newVersionIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UplinkPayloadPackage.UPLINK_MESSAGE__VERSION_IDS, null, msgs);
			msgs = basicSetVersionIds(newVersionIds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.UPLINK_MESSAGE__VERSION_IDS, newVersionIds, newVersionIds));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UplinkPayloadPackage.UPLINK_MESSAGE__RX_METADATA:
				return ((InternalEList<?>)getRxMetadata()).basicRemove(otherEnd, msgs);
			case UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS:
				return basicSetSettings(null, msgs);
			case UplinkPayloadPackage.UPLINK_MESSAGE__DECODED_PAYLOAD:
				return ((InternalEList<?>)getDecodedPayload()).basicRemove(otherEnd, msgs);
			case UplinkPayloadPackage.UPLINK_MESSAGE__NETWORK_IDS:
				return basicSetNetworkIds(null, msgs);
			case UplinkPayloadPackage.UPLINK_MESSAGE__VERSION_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UplinkPayloadPackage.UPLINK_MESSAGE__SESSION_KEY_ID:
				return getSessionKeyId();
			case UplinkPayloadPackage.UPLINK_MESSAGE__FPORT:
				return getFPort();
			case UplinkPayloadPackage.UPLINK_MESSAGE__FCNT:
				return getFCnt();
			case UplinkPayloadPackage.UPLINK_MESSAGE__FRM_PAYLOAD:
				return getFrmPayload();
			case UplinkPayloadPackage.UPLINK_MESSAGE__RX_METADATA:
				return getRxMetadata();
			case UplinkPayloadPackage.UPLINK_MESSAGE__SETTINGS:
				return getSettings();
			case UplinkPayloadPackage.UPLINK_MESSAGE__GATEWAY_CHANNEL_INDEX:
				return getGatewayChannelIndex();
			case UplinkPayloadPackage.UPLINK_MESSAGE__DEVICE_CHANNEL_INDEX:
			...
			case UplinkPayloadPackage.UPLINK_MESSAGE__CONSUMED_AIRTIME:
				return getConsumedAirtime();
			case UplinkPayloadPackage.UPLINK_MESSAGE__RECEIVED_AT:
