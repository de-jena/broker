 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.GatewayIdsImpl#getGatewayId <em>Gateway Id</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.GatewayIdsImpl#getEui <em>Eui</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GatewayIdsImpl extends MinimalEObjectImpl.Container implements GatewayIds {
	...
	protected EClass eStaticClass() {
		return UplinkPayloadPackage.eINSTANCE.getGatewayIds();
	}
	...
	public void setGatewayId(String newGatewayId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.GATEWAY_IDS__GATEWAY_ID, oldGatewayId, gatewayId));
	}
	...
	public void setEui(String newEui) {
		...
		eui = newEui;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.GATEWAY_IDS__EUI, oldEui, eui));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UplinkPayloadPackage.GATEWAY_IDS__GATEWAY_ID:
				return getGatewayId();
			case UplinkPayloadPackage.GATEWAY_IDS__EUI:
				return getEui();
		}
