...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.DataRate;
...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.Lora;
...
import org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.UplinkPayloadFactory;
 ...
 * @generated
 */
public class UplinkPayloadPackageImpl extends EPackageImpl implements UplinkPayloadPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.UplinkPayloadPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UplinkPayloadPackageImpl() {
		super(eNS_URI, UplinkPayloadFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link UplinkPayloadPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UplinkPayloadPackage init() {
		if (isInited) return (UplinkPayloadPackage)EPackage.Registry.INSTANCE.getEPackage(UplinkPayloadPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredUplinkPayloadPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UplinkPayloadPackageImpl theUplinkPayloadPackage = registeredUplinkPayloadPackage instanceof UplinkPayloadPackageImpl ? (UplinkPayloadPackageImpl)registeredUplinkPayloadPackage : new UplinkPayloadPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theUplinkPayloadPackage.createPackageContents();

		// Initialize created meta-data
		theUplinkPayloadPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theUplinkPayloadPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UplinkPayloadPackage.eNS_URI, theUplinkPayloadPackage);
		return theUplinkPayloadPackage;
	}
	 ...
	 */
	@Override
	public UplinkPayloadFactory getUplinkPayloadFactory() {
		return (UplinkPayloadFactory)getEFactoryInstance();
	}
