 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.VersionIdsImpl#getBrandId <em>Brand Id</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.VersionIdsImpl#getModelId <em>Model Id</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.VersionIdsImpl#getHardwareVersion <em>Hardware Version</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.VersionIdsImpl#getFirmwareVersion <em>Firmware Version</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.VersionIdsImpl#getBandId <em>Band Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionIdsImpl extends MinimalEObjectImpl.Container implements VersionIds {
	...
	protected EClass eStaticClass() {
		return UplinkPayloadPackage.eINSTANCE.getVersionIds();
	}
	...
	public void setBrandId(String newBrandId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.VERSION_IDS__BRAND_ID, oldBrandId, brandId));
	}
	...
	public void setModelId(String newModelId) {
		...
		modelId = newModelId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.VERSION_IDS__MODEL_ID, oldModelId, modelId));
	}
	...
	public void setHardwareVersion(String newHardwareVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.VERSION_IDS__HARDWARE_VERSION, oldHardwareVersion, hardwareVersion));
	}
	...
	public void setFirmwareVersion(String newFirmwareVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.VERSION_IDS__FIRMWARE_VERSION, oldFirmwareVersion, firmwareVersion));
	}
	...
	public void setBandId(String newBandId) {
		...
		bandId = newBandId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.VERSION_IDS__BAND_ID, oldBandId, bandId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UplinkPayloadPackage.VERSION_IDS__BRAND_ID:
				return getBrandId();
			case UplinkPayloadPackage.VERSION_IDS__MODEL_ID:
				return getModelId();
			case UplinkPayloadPackage.VERSION_IDS__HARDWARE_VERSION:
				return getHardwareVersion();
			case UplinkPayloadPackage.VERSION_IDS__FIRMWARE_VERSION:
				return getFirmwareVersion();
			case UplinkPayloadPackage.VERSION_IDS__BAND_ID:
				return getBandId();
		}
