 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.LoraImpl#getBandwidth <em>Bandwidth</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.LoraImpl#getSpreadingFactor <em>Spreading Factor</em>}</li>
 *   <li>{@link org.eclipse.sensinact.southbound.ttn.uplinkpayload.model.uplinkpayload.impl.LoraImpl#getCodingRate <em>Coding Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoraImpl extends MinimalEObjectImpl.Container implements Lora {
	...
	protected EClass eStaticClass() {
		return UplinkPayloadPackage.eINSTANCE.getLora();
	}
	...
	public void setBandwidth(long newBandwidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.LORA__BANDWIDTH, oldBandwidth, bandwidth));
	}
	...
	public void setSpreadingFactor(int newSpreadingFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.LORA__SPREADING_FACTOR, oldSpreadingFactor, spreadingFactor));
	}
	...
	public void setCodingRate(String newCodingRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UplinkPayloadPackage.LORA__CODING_RATE, oldCodingRate, codingRate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UplinkPayloadPackage.LORA__BANDWIDTH:
				return getBandwidth();
			case UplinkPayloadPackage.LORA__SPREADING_FACTOR:
				return getSpreadingFactor();
			case UplinkPayloadPackage.LORA__CODING_RATE:
