 ...
 * </p>
 * <ul>
 *   <li>{@link de.dim.trafficos.common.model.common.impl.AbstractTimeTableEntryImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link de.dim.trafficos.common.model.common.impl.AbstractTimeTableEntryImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link de.dim.trafficos.common.model.common.impl.AbstractTimeTableEntryImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link de.dim.trafficos.common.model.common.impl.AbstractTimeTableEntryImpl#getEnd <em>End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractTimeTableEntryImpl extends MinimalEObjectImpl.Container implements AbstractTimeTableEntry {
	...
	protected EClass eStaticClass() {
		return TOSCommonPackage.eINSTANCE.getAbstractTimeTableEntry();
	}
	...
	public void setIndex(int newIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__INDEX, oldIndex, index));
	}
	...
	public void setMode(ScheduleModeType newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__MODE, oldMode, mode));
	}
	...
	public void setBegin(long newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__BEGIN, oldBegin, begin));
	}
	...
	public void setEnd(long newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__END, oldEnd, end));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__INDEX:
				return getIndex();
			case TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__MODE:
				return getMode();
			case TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__BEGIN:
				return getBegin();
			case TOSCommonPackage.ABSTRACT_TIME_TABLE_ENTRY__END:
				return getEnd();
		}
